defmodule AssinanteTest do
  ...
  describe "Testes Assinante.cadastrar" do
    test "criar uma conta prepago" do
      assert Assinante.cadastrar("Itor", 123456, 43214213) == {:ok, "Assinante Itor cadastrado com sucesso!"}
    end

    test "deve retornar erro dizendo que assinante ja esta cadastrado" do
      Assinante.cadastrar("Itor", 123456, 43214213)
      assert Assinante.cadastrar("Itor", 123456, 43214213) == {:error, "Assinante com este numero já existe!"}
    end
  end
